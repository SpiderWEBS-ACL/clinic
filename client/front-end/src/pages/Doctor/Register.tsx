...
const steps = [
  {
    id: 1,
    title: "Personal Info",
    fields: ["Name", "Date of Birth", "Speciality"],
  },
  ...
  return (
    <div className="wrapper">
      <div className="header">
        <h1 className="h1">Apply to become a doctor</h1>
      </div>
              ...
              <div className="form_container">
                ...
                <div key="2" className="input_wrap">
                  ...
                  <input
                    className="input"
                    value={
                      Dob !== undefined ? Dob.toISOString().split("T")[0] : ""
                    }
              ...
              <div className="form_container">
                <div key="1" className="input_wrap">
                  ...
                  <input
                    className="input"
                    value={
                      HourlyRate !== undefined ? HourlyRate.toString() : ""
                    }
        ...
        <div className={`modal_wrapper ${modalActive ? "active" : ""}`}>
          ...
          <div className="success_wrap">
            <span className="modal_icon">
              <IonIcon name="checkmark-sharp"></IonIcon>
            </span>
